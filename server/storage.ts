...
export interface IStorage {
  ...
  // Participant methods
  createParticipant(
    participant: schema.InsertParticipant,
  ): Promise<schema.Participant>;
  getParticipant(id: number): Promise<schema.Participant | undefined>;
  getParticipantByRollNumber(
    rollNumber: string,
  ): Promise<schema.Participant | undefined>;
  ...
  ): Promise<schema.QuizWithQuestions | undefined>;
  getAllQuizzes(includeInactive?: boolean): Promise<schema.QuizWithQuestions[]>;
  updateQuiz(
    id: number,
    quiz: Partial<schema.InsertQuiz>,
  ...
  updateQuestion(
    id: number,
    question: Partial<schema.InsertQuestion>,
  ): Promise<schema.Question | undefined>;
  deleteQuestion(id: number): Promise<boolean>;
  deleteQuestionsByQuizId(quizId: number): Promise<number>;
  ...
  getResultWithDetails(
    id: number,
  ): Promise<schema.ResultWithDetails | undefined>;
  getAllResults(
    sortBy?: string,
    quizId?: number,
  ): Promise<schema.ResultWithDetails[]>;
  updateResultRetake(
    id: number,
    canRetake: boolean,
  ): Promise<schema.Result | undefined>;
...
export class DatabaseStorage implements IStorage {
  ...
  async getParticipantByRollNumber(
    rollNumber: string,
  ): Promise<schema.Participant | undefined> {
    return await db.query.participants.findFirst({
  ...
  async getQuiz(
    ...
    })) as schema.QuizWithQuestions | undefined;
  }

  async getAllQuizzes(
    includeInactive: boolean = false,
  ): Promise<schema.QuizWithQuestions[]> {
  ...
  async createQuestion(
    question: schema.InsertQuestion,
  ): Promise<schema.Question> {
  ...
  async createQuestionsBulk(
    ...
    return await db.insert(schema.questions).values(questions).returning();
  }
  ...
  async getResultsByParticipantId(
  ...
  async getAllResults(
    ...
    return results as schema.ResultWithDetails[];
  }

  async updateResultRetake(
    id: number,
    canRetake: boolean,
  ): Promise<schema.Result | undefined> {
